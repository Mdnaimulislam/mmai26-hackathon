"""Model C — PyKale Multimodal Fusion (tabular + text + vitals series).
...
but degrades towards Model A levels for the notes-absent cohort.
...
class ModelC(BaseEstimator, ClassifierMixin):
    ...
    # ── predict_proba (tabular-only fallback, used by generic app code) ───────
    ...
    def feature_importance(self) -> pd.Series:
        ...
        # FCNet uses weight_norm; the weight tensor is stored as 'weight_g' and 'weight_v'
        try:
